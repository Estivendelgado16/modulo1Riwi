...
-Busca el producto por nombre y permite cambiarle los datos
-Borra un producto del inventario usando su nombre
...
3. Si guardas el inventario, se crea un archivo CSV con los datos.
4 .Cuando vuelvas a ejecutar, puedes cargar ese archivo y seguir trabajando.
